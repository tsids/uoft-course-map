...
export function DisclaimerBanner() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-40 flex justify-center px-3 pb-3 sm:px-4 sm:pb-4">
      <div className="pointer-events-auto flex max-w-3xl items-center gap-3 rounded-2xl border border-amber-200 bg-surface/95 px-4 py-3 shadow-lg backdrop-blur dark:border-amber-500/30 dark:bg-header/95">
